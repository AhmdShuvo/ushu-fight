                            ...
                            <div className="col-lg-10">
                                <div className="bg-white p-5 shadow-sm" style={{ borderRadius: '15px' }}>
                                    <h4 className="mb-4 text-dark font-weight-bold" style={{ borderBottom: '2px solid #eee', paddingBottom: '15px' }}>
                                        <i className="fas fa-folder-open text-danger mr-2"></i> Available Files
                                    </h4>
                                        ...
                                        {data.documents.map((doc: any, i: number) => (
                                            <div className="list-group-item d-flex justify-content-between align-items-center px-0 py-4" key={i} style={{ borderBottom: '1px solid #eee' }} data-aos="fade-up" data-aos-duration="800" data-aos-delay={i * 100}>
                                                <div className="d-flex align-items-center">
                                                    <div className="icon-wrapper d-flex justify-content-center align-items-center" style={{ width: '60px', height: '60px', backgroundColor: 'rgba(220,53,69,0.1)', borderRadius: '10px', color: '#dc3545', fontSize: '24px', marginRight: '20px' }}>
                                                        <i className={`fas ${doc.icon}`}></i>
                                                    </div>
                                                    <div>
                                                        <h5 className="mb-1 text-dark" style={{ fontWeight: 'bold' }}>{doc.name}</h5>
                                                        <span className="text-muted" style={{ fontSize: '13px' }}>
                                                            <strong className="text-danger mr-2">{doc.type}</strong> •
                                                            <i className="far fa-hdd mx-2"></i> {doc.size} •
                                                            <i className="far fa-calendar-alt mx-2"></i> {doc.date}
                                                        </span>
                                                    </div>
                                                </div>
                                                <button className="btn btn-outline-danger" style={{ borderRadius: '30px', padding: '8px 25px', fontWeight: 'bold' }}>
                                ...
                                <div className="col-lg-4 col-md-6 mb-40" key={i} data-aos="zoom-in" data-aos-duration="1000" data-aos-delay={i * 100}>
                                    <div className="video-card position-relative" style={{ borderRadius: '15px', overflow: 'hidden', backgroundColor: '#111', cursor: 'pointer', group: 'true' }}>
                                        ...
                                        <div className="video-info p-4 text-white">
                                            ...
                                            <span className="text-white-50" style={{ fontSize: '13px' }}><i className="fas fa-user-circle mr-2 text-danger"></i>{video.author}</span>
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="row mb-60">
                            {data.stats.map((stat: any, i: number) => (
                                <div className="col-lg-3 col-md-6 mb-4 mb-lg-0" key={i} data-aos="fade-up" data-aos-duration="1000" data-aos-delay={i * 100}>
                                    <div className="stat-card text-center p-5 shadow-sm h-100 border-0" style={{ borderRadius: '15px', backgroundColor: '#fdfdfd', borderBottom: '4px solid #dc3545' }}>
                                        <i className={`fas ${stat.icon} fa-3x mb-4`} style={{ color: '#dc3545' }}></i>
                            ...
                            <div className="col-lg-10">
                                <div className="card shadow-sm border-0" style={{ borderRadius: '15px', overflow: 'hidden' }}>
                                    <div className="card-header bg-dark text-white p-4 border-0">
                                        <h4 className="mb-0"><i className="fas fa-history text-danger mr-2"></i> Hall of Fame / Recent Champions</h4>
                                    </div>
                                                    ...
                                                    {data.recentWinners.map((winner: any, i: number) => (
                                                        <tr key={i}>
                                                            ...
                                                            <td className="py-4 px-4 border-bottom-0">
                                                                <span className="text-danger font-weight-bold mr-2"><i className="fas fa-trophy"></i></span> {winner.championName}
                                                            </td>
