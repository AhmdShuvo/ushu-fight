...
export default function Trainer() {
    return (
        <section className="trainer-section ptb-120 bg-overlay-black bg_img" data-background="assets/images/bg/bg-2.png">
            <div className="container">
                    ...
                    <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-30">
                        <div className="trainer-item" data-aos="zoom-in" data-aos-duration="1200">
                            ...
                            <div className="trainer-content">
                                ...
                                <span className="sub-title">Karate Trainner</span>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-30">
                ...
                <div className="all-btn text-center mt-60">
                    <a href="master.html" className="btn--base">View All <i className="fas fa-arrow-right ml-2"></i></a>
                </div>
            </div>
        </section>
    );
