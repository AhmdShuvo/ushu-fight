...
export default function Tutorial() {
    return (
        <section className="tutorial-section ptb-120">
            <div className="container-fluid p-0">
                <div className="row justify-content-center">
                    <div className="col-xl-4 col-lg-8 col-md-6 text-center">
                        <div className="section-header">
                            <h2 className="section-title">OUR <span>KARATE</span> TUTORIAL</h2>
                        ...
                        <div className="tutorial-slider">
                            <div className="swiper-wrapper">
                                <div className="swiper-slide">
                                    <div className="tutorial-item">
                                        <div className="tutorial-thumb">
                                            <img src="assets/images/tutorial/tutorial-1.png" alt="tutorial" />
                                ...
                                <div className="swiper-slide">
                                    <div className="tutorial-item">
                                        <div className="tutorial-thumb">
                                            <img src="assets/images/tutorial/tutorial-2.png" alt="tutorial" />
                                            <div className="tutorial-overlay">
                                                <div className="tutorial-video">
                                                    <a className="video-icon" data-rel="lightcase:myCollection" href="https://www.youtube.com/embed/YDErI8Lphho">
                                                        <i className="fab fa-youtube"></i>
                                ...
                                <div className="swiper-slide">
                                    <div className="tutorial-item">
                                        <div className="tutorial-thumb">
                                            <img src="assets/images/tutorial/tutorial-3.png" alt="tutorial" />
                                            <div className="tutorial-overlay">
                                                <div className="tutorial-video">
                                                    <a className="video-icon" data-rel="lightcase:myCollection" href="https://www.youtube.com/embed/YDErI8Lphho">
                                                        <i className="fab fa-youtube"></i>
                                ...
                                <div className="swiper-slide">
                                    <div className="tutorial-item">
                                        <div className="tutorial-thumb">
                                            <img src="assets/images/tutorial/tutorial-4.png" alt="tutorial" />
                                            <div className="tutorial-overlay">
                                                <div className="tutorial-video">
                                                    <a className="video-icon" data-rel="lightcase:myCollection" href="https://www.youtube.com/embed/YDErI8Lphho">
                                                        <i className="fab fa-youtube"></i>
